...
wget https://github.com/didodr/plusnssh/raw/main/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/didodr/plusnssh/raw/main/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/didodr/plusnssh/raw/main/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/didodr/plusnssh/raw/main/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://github.com/didodr/plusnssh/raw/main/gestorssh/backupauto > /bin/autobackup.sh
